      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white py-2 text-sm font-medium text-gray-600 hover:bg-gray-50"
          >
            <svg
